...
//    public static final RegistrySupplier<Block> ROUND_SHOP_DISPLAY_SHELF_2 = registerDecorationItem("round_shop_display_shelf_2", () -> new ShopDisplayBlock(BlockBehaviour.Properties.of()));
    ...
    //public static final RegistrySupplier<BallDisplayBlock> CITRINE_BALL_DISPLAY = registerBallDisplay(DisplayState.CITRINE);
    //public static final RegistrySupplier<BallDisplayBlock> VERDANT_BALL_DISPLAY = registerBallDisplay(DisplayState.VERDANT);
    //public static final RegistrySupplier<BallDisplayBlock> AZURE_BALL_DISPLAY = registerBallDisplay(DisplayState.AZURE);
    //public static final RegistrySupplier<BallDisplayBlock> ROSEATE_BALL_DISPLAY = registerBallDisplay(DisplayState.ROSEATE);
    //public static final RegistrySupplier<BallDisplayBlock> SLATE_BALL_DISPLAY = registerBallDisplay(DisplayState.SLATE);
    ...
    //public static final RegistrySupplier<BallDisplayBlock> DREAM_BALL_DISPLAY = registerBallDisplay(DisplayState.DREAM);
    //public static final RegistrySupplier<BallDisplayBlock> BEAST_BALL_DISPLAY = registerBallDisplay(DisplayState.BEAST);
    ...
    //public static final RegistrySupplier<BallDisplayBlock> STRANGE_BALL_DISPLAY = registerBallDisplay(DisplayState.STRANGE);
    //public static final RegistrySupplier<BallDisplayBlock> ANCIENT_POKE_BALL_DISPLAY = registerBallDisplay(DisplayState.ANCIENT_POKE);
    //public static final RegistrySupplier<BallDisplayBlock> ANCIENT_CITRINE_BALL_DISPLAY = registerBallDisplay(DisplayState.ANCIENT_CITRINE);
    //public static final RegistrySupplier<BallDisplayBlock> ANCIENT_VERDANT_BALL_DISPLAY = registerBallDisplay(DisplayState.ANCIENT_VERDANT);
    //public static final RegistrySupplier<BallDisplayBlock> ANCIENT_AZURE_BALL_DISPLAY = registerBallDisplay(DisplayState.ANCIENT_AZURE);
    //public static final RegistrySupplier<BallDisplayBlock> ANCIENT_ROSEATE_BALL_DISPLAY = registerBallDisplay(DisplayState.ANCIENT_ROSEATE);
    //public static final RegistrySupplier<BallDisplayBlock> ANCIENT_SLATE_BALL_DISPLAY = registerBallDisplay(DisplayState.ANCIENT_SLATE);
    //public static final RegistrySupplier<BallDisplayBlock> ANCIENT_PREMIER_BALL_DISPLAY = registerBallDisplay(DisplayState.ANCIENT_PREMIER);
    //public static final RegistrySupplier<BallDisplayBlock> ANCIENT_GREAT_BALL_DISPLAY = registerBallDisplay(DisplayState.ANCIENT_GREAT);
    //public static final RegistrySupplier<BallDisplayBlock> ANCIENT_ULTRA_BALL_DISPLAY = registerBallDisplay(DisplayState.ANCIENT_ULTRA);
    //public static final RegistrySupplier<BallDisplayBlock> FEATHER_BALL_DISPLAY = registerBallDisplay(DisplayState.FEATHER);
    //public static final RegistrySupplier<BallDisplayBlock> WING_BALL_DISPLAY = registerBallDisplay(DisplayState.WING);
    //public static final RegistrySupplier<BallDisplayBlock> JET_BALL_DISPLAY = registerBallDisplay(DisplayState.JET);
    //public static final RegistrySupplier<BallDisplayBlock> ANCIENT_HEAVY_BALL_DISPLAY = registerBallDisplay(DisplayState.ANCIENT_HEAVY);
    //public static final RegistrySupplier<BallDisplayBlock> LEADEN_BALL_DISPLAY = registerBallDisplay(DisplayState.LEADEN);
    //public static final RegistrySupplier<BallDisplayBlock> GIGATON_BALL_DISPLAY = registerBallDisplay(DisplayState.GIGATON);
    //public static final RegistrySupplier<BallDisplayBlock> ORIGIN_BALL_DISPLAY = registerBallDisplay(DisplayState.ORIGIN);
    ...
    private static <T extends BlockItem> RegistrySupplier<T> register(String name, Function<Item.Properties, T> itemSupplier) {
        return GenerationsItems.ITEMS.register(name, () -> itemSupplier.apply(new Item.Properties().arch$tab(GenerationsCreativeTabs.DECORATION_BLOCKS)));
    }
