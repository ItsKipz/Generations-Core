...
//////////////////////////////////////////////////////////////////////////////
    ...
    //Consumables
        //Food
    public static final RegistrySupplier<Item> LAVA_COOKIE = register("lava_cookie", Item::new, GenerationsCreativeTabs.CONSUMABLES);
    public static final RegistrySupplier<Item> OLD_GATEAU = register("old_gateau", Item::new, GenerationsCreativeTabs.CONSUMABLES);
    public static final RegistrySupplier<Item> RAGE_CANDY_BAR = register("rage_candy_bar", Item::new, GenerationsCreativeTabs.CONSUMABLES);
    public static final RegistrySupplier<Item> CASTELIACONE = register("casteliacone", Item::new, GenerationsCreativeTabs.CONSUMABLES);
    public static final RegistrySupplier<Item> LUMIOSE_GALETTE = register("lumiose_galette", Item::new, GenerationsCreativeTabs.CONSUMABLES);
    public static final RegistrySupplier<Item> SHALOUR_SABLE = register("shalour_sable", Item::new, GenerationsCreativeTabs.CONSUMABLES);
    public static final RegistrySupplier<Item> BIG_MALASADA = register("big_malasada", Item::new, GenerationsCreativeTabs.CONSUMABLES);
    public static final RegistrySupplier<Item> FRESH_WATER = register("fresh_water", Item::new, GenerationsCreativeTabs.CONSUMABLES);
    public static final RegistrySupplier<Item> SODA_POP = register("soda_pop", Item::new, GenerationsCreativeTabs.CONSUMABLES);
    public static final RegistrySupplier<Item> LEMONADE = register("lemonade", Item::new, GenerationsCreativeTabs.CONSUMABLES);
    public static final RegistrySupplier<Item> MOOMOO_MILK = register("moomoo_milk", Item::new, GenerationsCreativeTabs.CONSUMABLES);
    public static final RegistrySupplier<Item> HONEY = register("honey", Item::new, GenerationsCreativeTabs.CONSUMABLES);
    public static final RegistrySupplier<Item> SWEET_HEART = register("sweet_heart", Item::new, GenerationsCreativeTabs.CONSUMABLES);
    public static final RegistrySupplier<Item> ENERGY_POWDER = register("energy_powder", Item::new, GenerationsCreativeTabs.CONSUMABLES);
    public static final RegistrySupplier<Item> DYNAMAX_CANDY = register("dynamax_candy", Item::new, GenerationsCreativeTabs.CONSUMABLES);
    public static final RegistrySupplier<Item> MAX_HONEY = register("max_honey", Item::new, GenerationsCreativeTabs.CONSUMABLES);
    public static final RegistrySupplier<Item> MAX_MUSHROOMS = register("max_mushrooms", Item::new, GenerationsCreativeTabs.CONSUMABLES);
    ...
    public static final RegistrySupplier<ItemWithLangTooltipImpl> SACRED_ASH = register("sacred_ash", properties -> new ItemWithLangTooltipImpl(properties.stacksTo(1).durability(1)), GenerationsCreativeTabs.CONSUMABLES);
        //Feather
    public static final RegistrySupplier<Item> HEALTH_FEATHER = register("health_feather", Item::new, GenerationsCreativeTabs.CONSUMABLES);
    public static final RegistrySupplier<Item> MUSCLE_FEATHER = register("muscle_feather", Item::new, GenerationsCreativeTabs.CONSUMABLES);
    public static final RegistrySupplier<Item> RESIST_FEATHER = register("resist_feather", Item::new, GenerationsCreativeTabs.CONSUMABLES);
    public static final RegistrySupplier<Item> GENIUS_FEATHER = register("genius_feather", Item::new, GenerationsCreativeTabs.CONSUMABLES);
    public static final RegistrySupplier<Item> CLEVER_FEATHER = register("clever_feather", Item::new, GenerationsCreativeTabs.CONSUMABLES);
    public static final RegistrySupplier<Item> SWIFT_FEATHER = register("swift_feather", Item::new, GenerationsCreativeTabs.CONSUMABLES);
        //Stats
    public static final RegistrySupplier<Item> BOTTLE_CAP = register("bottle_cap", Item::new, GenerationsCreativeTabs.CONSUMABLES);
    public static final RegistrySupplier<Item> GOLD_BOTTLE_CAP = register("gold_bottle_cap", Item::new, GenerationsCreativeTabs.CONSUMABLES);
    public static final RegistrySupplier<Item> ABILITY_CAPSULE = register("ability_capsule", Item::new, GenerationsCreativeTabs.CONSUMABLES);
    ...
    */
    ...
    public static final RegistrySupplier<ItemWithLangTooltipImpl> SHATTERED_ICE_KEY_4 = register("shattered_ice_key_4", ItemWithLangTooltipImpl::new, GenerationsCreativeTabs.LEGENDARY_ITEMS);
    public static final RegistrySupplier<RegiKeyItem> ICEBERG_KEY = register("iceberg_key", properties -> new RegiKeyItem(properties, LegendKeys.REGICE), GenerationsCreativeTabs.LEGENDARY_ITEMS);
    public static final RegistrySupplier<ItemWithLangTooltipImpl> CRUMBLED_ROCK_KEY_1 = register("crumbled_rock_key_1", ItemWithLangTooltipImpl::new, GenerationsCreativeTabs.LEGENDARY_ITEMS);
    public static final RegistrySupplier<ItemWithLangTooltipImpl> CRUMBLED_ROCK_KEY_2 = register("crumbled_rock_key_2", ItemWithLangTooltipImpl::new, GenerationsCreativeTabs.LEGENDARY_ITEMS);
    public static final RegistrySupplier<ItemWithLangTooltipImpl> CRUMBLED_ROCK_KEY_3 = register("crumbled_rock_key_3", ItemWithLangTooltipImpl::new, GenerationsCreativeTabs.LEGENDARY_ITEMS);
    public static final RegistrySupplier<ItemWithLangTooltipImpl> CRUMBLED_ROCK_KEY_4 = register("crumbled_rock_key_4", ItemWithLangTooltipImpl::new, GenerationsCreativeTabs.LEGENDARY_ITEMS);
    public static final RegistrySupplier<RegiKeyItem> ROCK_PEAK_KEY = register("rock_peak_key", properties -> new RegiKeyItem(properties, LegendKeys.REGIROCK), GenerationsCreativeTabs.LEGENDARY_ITEMS);
    public static final RegistrySupplier<ItemWithLangTooltipImpl> RUSTY_IRON_KEY_1 = register("rusty_iron_key_1", ItemWithLangTooltipImpl::new, GenerationsCreativeTabs.LEGENDARY_ITEMS);
    public static final RegistrySupplier<ItemWithLangTooltipImpl> RUSTY_IRON_KEY_2 = register("rusty_iron_key_2", ItemWithLangTooltipImpl::new, GenerationsCreativeTabs.LEGENDARY_ITEMS);
    public static final RegistrySupplier<ItemWithLangTooltipImpl> RUSTY_IRON_KEY_3 = register("rusty_iron_key_3", ItemWithLangTooltipImpl::new, GenerationsCreativeTabs.LEGENDARY_ITEMS);
    public static final RegistrySupplier<ItemWithLangTooltipImpl> RUSTY_IRON_KEY_4 = register("rusty_iron_key_4", ItemWithLangTooltipImpl::new, GenerationsCreativeTabs.LEGENDARY_ITEMS);
    public static final RegistrySupplier<RegiKeyItem> IRON_KEY = register("iron_key", properties -> new RegiKeyItem(properties, LegendKeys.REGISTEEL), GenerationsCreativeTabs.LEGENDARY_ITEMS);
    public static final RegistrySupplier<ItemWithLangTooltipImpl> FRAGMENTED_DRAGO_KEY_1 = register("fragmented_drago_key_1", ItemWithLangTooltipImpl::new, GenerationsCreativeTabs.LEGENDARY_ITEMS);
    public static final RegistrySupplier<ItemWithLangTooltipImpl> FRAGMENTED_DRAGO_KEY_2 = register("fragmented_drago_key_2", ItemWithLangTooltipImpl::new, GenerationsCreativeTabs.LEGENDARY_ITEMS);
    public static final RegistrySupplier<ItemWithLangTooltipImpl> FRAGMENTED_DRAGO_KEY_3 = register("fragmented_drago_key_3", ItemWithLangTooltipImpl::new, GenerationsCreativeTabs.LEGENDARY_ITEMS);
    public static final RegistrySupplier<ItemWithLangTooltipImpl> FRAGMENTED_DRAGO_KEY_4 = register("fragmented_drago_key_4", ItemWithLangTooltipImpl::new, GenerationsCreativeTabs.LEGENDARY_ITEMS);
    public static final RegistrySupplier<RegiKeyItem> DRAGO_KEY = register("drago_key", properties -> new RegiKeyItem(properties, LegendKeys.REGIDRAGO), GenerationsCreativeTabs.LEGENDARY_ITEMS);
    public static final RegistrySupplier<ItemWithLangTooltipImpl> DISCHARGED_ELEKI_KEY_1 = register("discharged_eleki_key_1", ItemWithLangTooltipImpl::new, GenerationsCreativeTabs.LEGENDARY_ITEMS);
    public static final RegistrySupplier<ItemWithLangTooltipImpl> DISCHARGED_ELEKI_KEY_2 = register("discharged_eleki_key_2", ItemWithLangTooltipImpl::new, GenerationsCreativeTabs.LEGENDARY_ITEMS);
    ...
    public static final RegistrySupplier<RegiKeyItem> ELEKI_KEY = register("eleki_key", properties -> new RegiKeyItem(properties, LegendKeys.REGIELEKI), GenerationsCreativeTabs.LEGENDARY_ITEMS);
    ...
    public static final RegistrySupplier<ElementalPostBattleUpdateItemImpl> FADED_BLUE_ORB = register("faded_blue_orb", properties -> new ElementalPostBattleUpdateItemImpl(properties.stacksTo(1).durability(300), ElementalTypes.INSTANCE.getWATER()), GenerationsCreativeTabs.LEGENDARY_ITEMS);
    public static final RegistrySupplier<ElementalPostBattleUpdateItemImplImpl> FADED_JADE_ORB = register("faded_jade_orb", properties -> new ElementalPostBattleUpdateItemImplImpl(properties.stacksTo(1).durability(300), LegendKeys.RAYQUAZA, ElementalTypes.INSTANCE.getFLYING()), GenerationsCreativeTabs.LEGENDARY_ITEMS);
    ...
    public static final RegistrySupplier<TaoTrioStoneItem> LIGHT_STONE = register("light_stone", properties -> new TaoTrioStoneItem(properties.stacksTo(1).durability(100), LegendKeys.RESHIRAM), GenerationsCreativeTabs.LEGENDARY_ITEMS);
    ...
    public static final RegistrySupplier<WingItem> ICY_WING = register("icy_wing", properties -> new WingItem(properties.stacksTo(1), "icy", ElementalTypes.INSTANCE.getICE(), LegendKeys.ARTICUNO), GenerationsCreativeTabs.LEGENDARY_ITEMS);
    public static final RegistrySupplier<WingItem> ELEGANT_WING = register("elegant_wing", properties -> new WingItem(properties.stacksTo(1), "elegant", ElementalTypes.INSTANCE.getPSYCHIC(), LegendKeys.GALARIAN_ARTICUNO), GenerationsCreativeTabs.LEGENDARY_ITEMS);
    public static final RegistrySupplier<WingItem> STATIC_WING = register("static_wing", properties -> new WingItem(properties.stacksTo(1), "static", ElementalTypes.INSTANCE.getELECTRIC(), LegendKeys.ZAPDOS), GenerationsCreativeTabs.LEGENDARY_ITEMS);
    public static final RegistrySupplier<WingItem> BELLIGERENT_WING = register("belligerent_wing", properties -> new WingItem(properties.stacksTo(1), "belligerent", ElementalTypes.INSTANCE.getFIGHTING(), LegendKeys.GALARIAN_ZAPDOS), GenerationsCreativeTabs.LEGENDARY_ITEMS);
    public static final RegistrySupplier<WingItem> FIERY_WING = register("fiery_wing", properties -> new WingItem(properties.stacksTo(1).fireResistant(), "fiery", ElementalTypes.INSTANCE.getFIRE(), LegendKeys.MOLTRES), GenerationsCreativeTabs.LEGENDARY_ITEMS);
    ...
    public static final RegistrySupplier<WingItem> SILVER_WING = register("silver_wing", properties -> new WingItem(properties.stacksTo(1), "silver", ElementalTypes.INSTANCE.getFLYING(), LegendKeys.LUGIA), GenerationsCreativeTabs.UNIMPLEMENTED);
    ...
    public static final RegistrySupplier<Item> BLACK_FLUTE = register("black_flute", Item::new, GenerationsCreativeTabs.UNIMPLEMENTED);
    public static final RegistrySupplier<Item> WHITE_FLUTE = register("white_flute", Item::new, GenerationsCreativeTabs.UNIMPLEMENTED);
