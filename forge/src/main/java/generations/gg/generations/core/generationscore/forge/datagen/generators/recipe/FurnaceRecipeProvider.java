...
public class FurnaceRecipeProvider extends GenerationsRecipeProvider.Proxied implements IConditionBuilder {
    ...
    protected void buildRecipes(@NotNull Consumer<FinishedRecipe> consumer) {
        ...
        var aluminum_ingredient = Ingredient.of(GenerationsTools.ALUMINUM.pickaxe().get(), GenerationsTools.ALUMINUM.shovel().get(), GenerationsTools.ALUMINUM.axe().get(), GenerationsTools.ALUMINUM.hoe().get(), GenerationsTools.ALUMINUM.sword().get(), GenerationsArmor.ALUMINUM.helmet().get(), GenerationsArmor.ALUMINUM.chestplate().get(), GenerationsArmor.ALUMINUM.leggings().get(), GenerationsArmor.ALUMINUM.boots().get());

        SimpleCookingRecipeBuilder.smelting(aluminum_ingredient, RecipeCategory.MISC, GenerationsItems.ALUMINUM_NUGGET.get(), 0.1F, 200).unlockedBy("has_aluminum_pickaxe", has(GenerationsTools.ALUMINUM.pickaxe().get())).unlockedBy("has_aluminum_shovel", has(GenerationsTools.ALUMINUM.shovel().get())).unlockedBy("has_aluminum_axe", has(GenerationsTools.ALUMINUM.axe().get())).unlockedBy("has_aluminum_hoe", has(GenerationsTools.ALUMINUM.hoe().get())).unlockedBy("has_aluminum_sword", has(GenerationsTools.ALUMINUM.sword().get())).unlockedBy("has_aluminum_helmet", has(GenerationsArmor.ALUMINUM.helmet().get())).unlockedBy("has_aluminum_chestplate", has(GenerationsArmor.ALUMINUM.chestplate().get())).unlockedBy("has_aluminum_leggings", has(GenerationsArmor.ALUMINUM.leggings().get())).unlockedBy("has_aluminum_boots", has(GenerationsArmor.ALUMINUM.boots().get())).save(consumer, getSmeltingRecipeName(GenerationsItems.ALUMINUM_NUGGET.get()));
        SimpleCookingRecipeBuilder.blasting(aluminum_ingredient, RecipeCategory.MISC, GenerationsItems.ALUMINUM_NUGGET.get(), 0.1F, 200).unlockedBy("has_aluminum_pickaxe", has(GenerationsTools.ALUMINUM.pickaxe().get())).unlockedBy("has_aluminum_shovel", has(GenerationsTools.ALUMINUM.shovel().get())).unlockedBy("has_aluminum_axe", has(GenerationsTools.ALUMINUM.axe().get())).unlockedBy("has_aluminum_hoe", has(GenerationsTools.ALUMINUM.hoe().get())).unlockedBy("has_aluminum_sword", has(GenerationsTools.ALUMINUM.sword().get())).unlockedBy("has_aluminum_helmet", has(GenerationsArmor.ALUMINUM.helmet().get())).unlockedBy("has_aluminum_chestplate", has(GenerationsArmor.ALUMINUM.chestplate().get())).unlockedBy("has_aluminum_leggings", has(GenerationsArmor.ALUMINUM.leggings().get())).unlockedBy("has_aluminum_boots", has(GenerationsArmor.ALUMINUM.boots().get())).save(consumer, getBlastingRecipeName(GenerationsItems.ALUMINUM_NUGGET.get()));
